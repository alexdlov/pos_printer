...
import com.example.pos_printer.bluetooth.BluetoothConnection
import com.example.pos_printer.bluetooth.BluetoothConstants
import com.example.pos_printer.bluetooth.BluetoothService
import com.example.pos_printer.bluetooth.BluetoothService.Companion.TAG
import com.example.pos_printer.usb.USBPrinterService
...
/** PosPrinterPlugin - POS thermal printer plugin for Flutter */
class PosPrinterPlugin : FlutterPlugin, MethodCallHandler, PluginRegistry.RequestPermissionsResultListener,
    ...
    private final var TAG = "PosPrinterPlugin"
...
//            Manifest.permission.BLUETOOTH_ADMIN,
    ...
    companion object {
        ...
        const val methodChannel = "com.example.pos_printer"
        const val eventChannelBT = "com.example.pos_printer/bt_state"
        const val eventChannelUSB = "com.example.pos_printer/usb_state"
